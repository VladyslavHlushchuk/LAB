...
// mysqli_query($db_server, "drop table duscup");
    ...
    mysqli_query($db_server, "insert into dusc (name_d, key_concept) values ('AI','Modeling')");
// ?>
...
<html>
    ...
    <body>
        ...
        <h3 class='back'><a href='lab8.php'>Назад</a></h3>
    </body>
</html>